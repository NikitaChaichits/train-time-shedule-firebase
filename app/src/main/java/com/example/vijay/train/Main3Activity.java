    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3);
            ...
            but4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent to = new Intent(Main3Activity.this,Main8Activity.class);
            ...
            but5.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent to = new Intent(Main3Activity.this, Main9Activity.class);
        ...
        but6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent to = new Intent(Main3Activity.this, Main14Activity.class);
        ...
        pre=(Button)findViewById(R.id.button10);
